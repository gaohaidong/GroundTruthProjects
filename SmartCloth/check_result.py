...
if __name__ == '__main__':
    big_dir = '/media/gait/DATA/04data/01competitions/11tianchi_bupi/'
    ############################round 1############################
    # step 1: get the algorithm result
    res_pth = big_dir + 'cloth-x101-crop-tc-tx.csv'
    ...
    xml_dir = big_dir + '/round1/r1teb_xml/'
    ...
    ############################round 2############################
    # step 1: get the algorithm result
    #res_pth = big_dir + 'merged_scale.csv'
    #res_pth = big_dir + 'round1_test_47cls_crop2_crop_2.csv'
    #res_pth = big_dir + 'round2_test_47cls_round2_det_prob.csv'
    res_pth = big_dir + 'round1_test_47cls_crop2_crop_2.csv_round2_test_47cls_round2_det_prob.csv.csv'
